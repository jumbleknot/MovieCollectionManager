...
```mermaid
C4Container
  title Software Ecosystem Architecture Diagram
  ...
  System_Boundary(software_ecosystem, "Software Ecosystem") {
  ...
  Rel_R(app1_user, app1_web, "Uses")
  Rel_R(app1_user, app1_mobile, "Uses")
  Rel_R(app2_user, app2_web, "Uses")

  Rel_R(app1_web, app1_bff_api, "Calls", "REST")
  Rel_R(app1_mobile, app1_bff_api, "Calls", "REST")
  Rel_R(app2_web, app2_bff_api, "Calls", "REST")

  Rel_D(app1_bff_api, app1_bff_cache, "Reads/Writes", "NoSQL")
  Rel_D(app2_bff_api, app2_bff_cache, "Reads/Writes", "NoSQL")

  Rel_R(app1_bff_api, service1_api, "Routes to", "REST/GraphQL")
  Rel_R(app1_bff_api, service2_api, "Routes to", "REST/GraphQL")
  Rel_R(app2_bff_api, service1_api, "Routes to", "REST/GraphQL")
  Rel_R(app2_bff_api, service2_api, "Routes to", "REST/GraphQL")

  Rel_D(service1_api, service1_db, "Reads/Writes", "SQL")
  Rel_D(service2_api, service2_db, "Reads/Writes", "NoSQL")

  Rel_D(app1_bff_api, keycloak, "Authenticates", "REST")
  Rel_D(app2_bff_api, keycloak, "Authenticates", "REST")
  Rel_D(service1_api, keycloak, "Validates token", "REST")
  Rel_D(service2_api, keycloak, "Validates token", "REST")
```
