...
- [OpenWiki bundle generation and maintenance](wiki-maintenance.md) - How this openwiki/ knowledge bundle is generated, updated, and gated — the wiki-update and okf-lint Nx targets, the drift/uncited-triggered (not per-feature) freshness model, and what the conformance gate actually enforces.
