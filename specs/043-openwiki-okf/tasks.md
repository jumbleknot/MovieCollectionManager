...
- [~] T041 Full validation per the Final Validation Checklist: `pnpm nx lint mcm-app`, `pnpm nx typecheck mcm-app`, `pnpm nx test mcm-app`, `pnpm nx test mc-service`, `pnpm nx test:integration mc-service`.
