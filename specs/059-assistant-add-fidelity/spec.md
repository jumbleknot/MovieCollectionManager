...
- **The external data source's certification data is available under the existing access arrangement** — no new credential, quota tier, or contractual change is assumed.
