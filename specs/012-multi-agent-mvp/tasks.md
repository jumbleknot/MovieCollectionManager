...
- [ ] T063 [P] Add golden-pair exemplars per story; wire the deployment gate to **block on regression** (runs against **Anthropic Claude — the prod provider**, research R1 revised 2026-06-07; dev/test iterate on Ollama)
