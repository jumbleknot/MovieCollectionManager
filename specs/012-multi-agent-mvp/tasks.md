...
|---|---|---|---|
| US1-AC1/2/3: add named movie → preview+approval → approve/reject | ✅ `assistant-add.spec.ts` (T037) | `[create: assistant-add.yaml]` | Web ✅ · Mobile ❌ → T038 |
| US1-AC4: duplicate-submission retry adds once | ✅ SC-006 at integration (T036) | `[create: assistant-add.yaml]` | Web ✅ (T036) · Mobile ❌ → T038 |
...
| US1-AC6: create-collection-if-missing in one preview | ✅ `assistant-add.spec.ts` (T037) | `[create: assistant-add.yaml]` | Web ✅ · Mobile ❌ → T038 |
